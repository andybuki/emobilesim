...
class SimulationTask {
    ...
    private static def log = LogFactory.getLog( SimulationTask.class )
    ...
    def searchFillingStation() {
        ...
        log.debug( "found a station, try to get a route and a route back" )
        ...
        log.debug( "found routes, try to append to route plan" )
