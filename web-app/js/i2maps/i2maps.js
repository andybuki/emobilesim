...
var i2maps;
var includes = [
    "http://localhost:8080/emobilesim2/js/i2maps/OpenLayers.js",
    "http://localhost:8080/emobilesim2/js/i2maps/jquery-1.3.2.min.js",
    "http://localhost:8080/emobilesim2/js/i2maps/jquery-ui-1.7.2.custom.min.js",
    "http://localhost:8080/emobilesim2/js/i2maps/jquery.mousewheel.js",
    "http://localhost:8080/emobilesim2/js/i2maps/jquery.flot.js",
    "http://localhost:8080/emobilesim2/js/i2maps/jquery.dataTables.js",
    "http://localhost:8080/emobilesim2/js/i2maps/ui.panel.min.js",
    "http://localhost:8080/emobilesim2/js/i2maps/json2.js",
    "http://localhost:8080/emobilesim2/js/i2maps/timeline.js",
    "http://localhost:8080/emobilesim2/js/i2maps/circle.js",
    "http://localhost:8080/emobilesim2/js/i2maps/colormap.js",
    "http://localhost:8080/emobilesim2/js/i2maps/surface.js",
    "http://localhost:8080/emobilesim2/js/i2maps/canvas.js",
    "http://localhost:8080/emobilesim2/js/i2maps/cloudmade.js",
    "http://localhost:8080/emobilesim2/js/i2maps/OpenLayers-ext-min.js",
    "http://maps.google.com/maps?file=api&amp;v=2&amp;key=ABQIAAAAGwcE_6OjqiQ_gkEzT4zkehRQ6XxsilBjt0Se4vGYlThGy_5z-RQyP_fTE8P7wYPDMpFVbuL60-fJvQ",
    "http://localhost:8080/emobilesim2/js/i2maps/basic.js"
]
...
function load_i2maps()
{
    ...
    loadIncludes = function()
    {
        ...
        {
            requireJS(includes[x]);
        }
    }
    loadIncludes();
    // requireCSS("jquery-ui-1.7.2.custom.css");
    requireCSS('http://localhost:8080/emobilesim2/css/i2maps/jquery-ui-aristo.css');
    requireCSS("http://localhost:8080/emobilesim2/css/i2maps/ui.panel.css");
    requireCSS("http://localhost:8080/emobilesim2/css/i2maps/i2maps.css");
    ...
    function setupUtils()
    {
        ...
        OpenLayers.imgPath = i2MAPS_URL + 'media/images/';
    ...
    i2maps = {
        ...
        /**
         * changed this method to make requests in json and
         * also get response as json
         *
         * importantos: out: ( callback, .. ) as JSON , action : action,
         *              in : ( response as JSON ), result_handler
         *
         * @param query_string
         * @param action
         * @param parameters
         ...
         */
        doQuery: function(query_string, action, parameters, data_source, result_handler)
        {
            query_request = jQuery.ajax({
                url: i2MAPS_URL + action,
        ...
        Map: new Class(
            {
                ...
                initialize: function(options) {
                    ...
                    if(this.baseLayers.length == 0)
                    {
                        ...
                        this.olMap.allOverlays = true;
                    }
                    this.olMap.selectControl = new OpenLayers.Control.SelectFeature(
                        this.layers.filter(function(l){return l.isVector})
                    );
                    this.olMap.selectControl.handlers.feature.stopDown = false; // hack for dragging vector layers
                    this.olMap.addControl(this.olMap.selectControl);
                    this.olMap.selectControl.activate();
