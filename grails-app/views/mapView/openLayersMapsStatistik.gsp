...
<script type="text/javascript">
    ...
    var gasolineSlowIcon = new OpenLayers.Icon( "${g.resource( dir: '/images', file: 'gasolineslow.png' )}" , gasolineIconSize );
    ...
    var stationsDat = new Object();

    <g:each var="station" in="${stationList}">

        var stations = new Array();
        stationsDat.fromX = ${station.lat};
        stationsDat.fromY = ${station.lon};
        drawGasolineStation( stationsDat );
    </g:each>
