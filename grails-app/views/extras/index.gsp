...
<div class="newCar">
    <div class="contentLeft">
        <div class="layoutCellU">
            <div class="leftbig"><b>Car types:</b></div>
        </div>
        ...
        <div class="layoutCellL">
            ...
            <div class="right">
                <a class="addButton" onclick=""><img width="22px" src="${g.resource( dir: '/images', file: 'add.png' )}"><span class="addButtonText"> add new car type</span></a>
            </div>
        </div>
    </div>
</div>
