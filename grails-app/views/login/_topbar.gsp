                ...
                <nav>
                    <ul id="menu">
                        ...
                        <span class="registration2">
                            <span class="flags1">
                                <g:link controller="${params.controller}" action="${params.action}" params="[lang:'de']"><img width="20" src="${g.resource( dir: '/images', file: 'de.png' )}"></g:link>&nbsp;
                                <g:link controller="${params.controller}" action="${params.action}" params="[lang:'en']"><img width="20" src="${g.resource( dir: '/images', file: 'uk.png' )}"></g:link>
                            </span>
                        </span>
                    </ul>
