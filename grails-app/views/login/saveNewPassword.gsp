...
<span class="confirmEmail">
    <p>
        <g:message code="login.nopassword.noexist"/>
        <br><br>
        <g:message code="login.nopassword.tryitagain"/> <g:link uri="${loginLink}" url="${loginLink}"> <span class="loginName"><g:message code="login.success.login"/> </span></g:link>
    </p>
