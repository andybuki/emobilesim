<div id="footer">
    <span class="footerEmail"><g:message code="layouts.footer.name"/>
    ...
    <span class="logos">
        ...
        <span class="footerText"><g:message code="layouts.footer.coordinated"/></span>
        <a href="http://www.emo-berlin.de/de/"><g:img class="emoLogo"  uri="${resource(dir: '/images', file: 'emo.png')}"/></a>
    </span>
</div>