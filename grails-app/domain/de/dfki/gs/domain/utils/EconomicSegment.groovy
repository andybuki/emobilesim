...
public enum EconomicSegment {
    ...
    CONSTRUCTION_OF_BUILDINGS("Construction of buildings"),
    ...
    RETAIL_TRADE_EXCEPT_OF_MOTOR_VEHICLES_AND_MOTORCYCLES("Retail trade. except of motor vehicles and motorcycles"),
    ...
    SOCIAL_WORK_ACTIVITIES_WITHOUT_ACCOMMODATION("Social work activities without accommodation"),
